    ...
    (function p(v, l, c) {
      ...
      4: [function(p, v, l) {
        ...
        function u(g, b, a, c, f) {
          f || (q(void 0 !== b && null !== b, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 3 < g.length, "Trying to write beyond buffer length"), E(b, 3.4028234663852886E38, -3.4028234663852886E38));
          a >= g.length || J.write(g, b, a, c, 23, 4);
        }
        function M(g, b, a, c, f) {
          f || (q(void 0 !== b && null !== b, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 7 < g.length, "Trying to write beyond buffer length"), E(b, 1.7976931348623157E308, -1.7976931348623157E308));
          ...
          for (var c = 1,
            ...
            if (";" === b.charAt(x))
              ...
              if (q = v[E])
                ...
                for (q = []; x < D; )
                  n.decode(b, x, A), J = A.value, x = A.rest, q.push(J);
                if (2 === q.length)
        ...
        c.prototype._serializeMappings = function() {
          for (var a = 0,
            ...
            if (p.generatedLine !== c)
              ...
              if (!k.compareByGeneratedPositionsInflated(p, C[v - 1]))
                continue;
              u += ",";
            }
      ...
      19: [function(p, v, l) {
        (function(c, e) {
          ...
          function v(a) {
            ...
            if (b) {
              ...
              var c = +b[2],
                  b = +b[3],
                  d = A[a];
              !d && C && C.existsSync(a) && (d = C.readFileSync(a, "utf8"));
              if (d && (d = d.split(/(?:\r\n|\r|\n)/)[c - 1]))
                return a + ":" + c + "\n" + d + "\n" + Array(b).join(" ") + "^";
            }
            return null;
          ...
          z.push(function(a) {
            ...
            var b = null;
            if (C)
              C.existsSync(a) && (b = C.readFileSync(a, "utf8"));
            else {
